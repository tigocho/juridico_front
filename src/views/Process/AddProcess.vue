                              ...
                              <b-row>
                                <b-form-group class="col-md-6" label="Fecha de Ingreso" label-for="prore_fec_ingreso">
                                  <div v-if="!editing && proc_id != null && formData.prore_fec_ingreso != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_ingreso}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_ingreso == null">
                                ...
                                <b-form-group class="col-md-6" label="Clinica/IPS" label-for="prore_defendant_clin">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.cli_name}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_defendant_clin == null">
                                ...
                                <b-form-group class="col-md-6" label="Año del Siniestro" label-for="prore_year_sinister">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_year_sinister}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_year_sinister == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha del Siniestro" label-for="prore_fec_sinister">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_sinister}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_sinister == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha de notificación prejudicial" label-for="prore_fec_noti_preju">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_noti_preju}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_noti_preju == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha de la audiencia de conciliación prejudicial" label-for="prore_fec_audi_conci_preju">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_audi_conci_preju}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_audi_conci_preju == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha aviso del siniestro" label-for="prore_fec_sinies_aviso">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_sinies_aviso}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_sinies_aviso == null">
                                ...
                                <b-form-group class="col-md-6" label="Patología" label-for="patologia">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_pathology}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_pathology == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha de recibo de notificación IPS" label-for="prore_fec_recibo_notify">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_recibo_notify}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_recibo_notify == null">
                                ...
                                <b-form-group class="col-md-6" label="Colaborador de IPS que recibe notificación" label-for="prore_fec_recibo_notify">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_colaborador_ips}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_colaborador_ips == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha de Ingreso a Juridico" label-for="prore_fec_ingreso_jur">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_ingreso_jur}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_fec_ingreso_jur == null">
                                ...
                                <b-form-group class="col-md-6" label="Fecha de Ingreso a Clínica" label-for="prore_fec_ingreso_cli">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_fec_ingreso_cli}}</span>
                                  </div>
                                ...
                                <b-form-group class="col-md-6" label="Primer Nombre Paciente" label-for="prore_pac_name_first">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_pac_name_first}}</span>
                                  </div>
                                ...
                                <b-form-group class="col-md-6" label="Segundo Nombre Paciente" label-for="prore_pac_name_secdon">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_pac_name_second}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_pac_name_second == null">
                                ...
                                <b-form-group class="col-md-6" label="Primer Apellido Paciente" label-for="prore_pac_lastname_first">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_pac_lastname_first}}</span>
                                  </div>
                                ...
                                <b-form-group class="col-md-6" label="Segundo Apellido Paciente" label-for="prore_pac_lastname_second">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_pac_lastname_second}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_pac_lastname_second == null">
                                ...
                                <b-form-group class="col-md-6" label="Edad del paciente" label-for="prore_pac_age">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_pac_age}}</span>
                                  </div>
                            ...
                            <div class="new-user-info">
                              <b-row>
                                <b-form-group class="col-md-6" label="Primer Nombre" label-for="prore_applicant_name_first">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_applicant_name_first}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_applicant_name_first == null">
                                ...
                                <b-form-group class="col-md-6" label="Segundo Nombre" label-for="prore_applicant_name_secdon">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_applicant_name_secdon}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_applicant_name_secdon == null">
                                ...
                                <b-form-group class="col-md-6" label="Primer Apellido" label-for="prore_applicant_lastname_first">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_applicant_lastname_first}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_applicant_lastname_first == null">
                                ...
                                <b-form-group class="col-md-6" label="Segundo Apellido" label-for="prore_applicant_lastname_second">
                                  <div v-if="!editing && proc_id != null">
                                    <span class='text' @click="enableEditing">{{formData.prore_applicant_lastname_second}}</span>
                                  </div>
                                  <div v-if="editing || proc_id == null || formData.prore_applicant_lastname_second == null">
                              ...
                              <div class="new-user-info">
                                <b-row>
                                  <b-form-group class="col-md-6" label="Primer Nombre" label-for="prore_defendant_name_first">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_defendant_name_first}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_defendant_name_first == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Segundo Nombre" label-for="prore_defendant_name_second">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_defendant_name_second}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_defendant_name_second == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Primer Apellido" label-for="prore_defendant_lastname_first">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_defendant_lastname_first}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_defendant_lastname_first == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Segundo Apellido" label-for="prore_defendant_lastname_second">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_defendant_lastname_second}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_defendant_lastname_second == null">
                              ...
                              <div class="new-user-info">
                                <b-row>
                                  <b-form-group class="col-md-6" label="Primer Nombre" label-for="prore_warranty_name_first">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_warranty_name_first}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_warranty_name_first == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Segundo Nombre" label-for="prore_warranty_name_second">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_warranty_name_second}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_warranty_name_second == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Primer Apellido" label-for="prore_warranty_lastname_first">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_warranty_lastname_first}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_warranty_lastname_first == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Segundo Apellido" label-for="prore_warranty_lastname_second">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_warranty_lastname_second}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_warranty_lastname_second == null">
                              ...
                              <div class="new-user-info">
                                <b-row>
                                  ...
                                  <b-form-group class="col-md-6" label="Juzgado" label-for="prore_court_id">
                                    <!--<div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_court_id}}</span>
                                    </div>
                                  ...
                                  <template>
                                    <b-form-group class="col-md-6" label="Proceso Ejecutivo" label-for="prore_proceso_ejecutivo">
                                      <div v-if="!editing && proc_id != null">
                                        <span class='text' @click="enableEditing">{{formData.prore_proceso_ejecutivo}}</span>
                                      </div>
                                      <div v-if="editing || proc_id == null || formData.prore_proceso_ejecutivo == null">
                                    ...
                                    <b-form-group class="col-md-6" label="Ejecutante" label-for="prore_ejecutante">
                                      <div v-if="!editing && proc_id != null">
                                        <span class='text' @click="enableEditing">{{formData.prore_ejecutante}}</span>
                                      </div>
                                      <div v-if="editing || proc_id == null || formData.prore_ejecutante == null">
                                    ...
                                    <b-form-group class="col-md-6" label="Medida Cuatelar" label-for="prore_medida_cautelar">
                                      <div v-if="!editing && proc_id != null">
                                        <span class='text' @click="enableEditing">{{formData.prore_medida_cautelar}}</span>
                                      </div>
                                      <div v-if="editing || proc_id == null || formData.prore_medida_cautelar == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Valor Lucro Cesante" label-for="prore_val_luc_cesante">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_val_luc_cesante}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_val_luc_cesante == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Valor daño Emergente" label-for="prore_val_dano_emergente">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_val_dano_emergente}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_val_dano_emergente == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Total Perjuicios Materiales" label-for="prore_total_perjuicios_materiales">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_total_perjuicios_materiales}}</span>
                                    </div>
                                  ...
                                  <b-form-group class="col-md-6" label="Estimado Del Monto A Pagar Por Perjuicios Materiales" label-for="prore_estimacion_pago_perju">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_estimacion_pago_perju_materiales}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_estimacion_pago_perju_materiales == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Valor Daño Moral" label-for="prore_val_dano_moral">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='number' @click="enableEditing">{{formData.prore_val_dano_moral}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_val_dano_moral == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Daño a la Vida ó Prejuicios Fisiologicos y Otros" label-for="prore_val_dano_vida">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='number' @click="enableEditing">{{formData.prore_val_dano_vida}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_val_dano_vida == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Prescritas" label-for="prore_prescritas">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_prescritas}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_prescritas == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Fecha Sentencia Primera Instancia" label-for="prore_fec_sentencia_primera_instancia">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_fec_sentencia_primera_instancia}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_fec_sentencia_primera_instancia == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Fecha de Consulta" label-for="prore_fec_consulta">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_fec_consulta}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_fec_consulta == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Fecha de Sentencia Segunda Instancia" label-for="prore_fec_sentencia_segunda_instancia">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_fec_sentencia_segunda_instancia}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_fec_sentencia_segunda_instancia == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Valor De La Sentencia Final" label-for="prore_val_sentencia_final">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_val_sentencia_final}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_val_sentencia_final == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Discriminar Valor De La Condena" label-for="prore_discriminar_val_condena">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_discriminar_val_condena}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_discriminar_val_condena == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Costas De La Sentencia" label-for="prore_costas_sentencia">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_costas_sentencia}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_costas_sentencia == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Costas Procesales Primera Instancia" label-for="prore_costas_procesales_primera_instancia">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_costas_procesales_primera_instancia}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_costas_procesales_primera_instancia == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Costas Procesales Segunda Instancia" label-for="prore_costas_procesales_segunda_instancia">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_costas_procesales_segunda_instancia}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_costas_procesales_segunda_instancia == null">
                                  ...
                                  <b-form-group class="col-md-6" label="Total Costas" label-for="prore_total_costas">
                                    <div v-if="!editing && proc_id != null">
                                      <span class='text' @click="enableEditing">{{formData.prore_total_costas}}</span>
                                    </div>
                                    <div v-if="editing || proc_id == null || formData.prore_total_costas == null">
