      ...
      <div v-if="!editando">
        <b-row>
          <b-col md="6">
            ...
            <b-card-text class="text-center"><h4><strong>TOTAL:</strong> <span v-if="process.prore_val_dano_vida == null && process.prore_val_dano_emergente == null && process.prore_val_dano_moral == null && process.prore_otros_valores == null"> 0 </span><span v-else>{{ formatPrice(process.prore_val_dano_moral + process.prore_val_dano_vida + process.prore_val_dano_emergente + process.prore_otros_valores) }}</span></h4></b-card-text>
          </b-col>
          <b-col md="6">
